        ...
        <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-md max-w-lg mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="mb-4 col-span-2">
                    <label htmlFor="text" className="block text-gray-700 text-sm font-bold mb-2">タスク名</label>
                    <input
                    type="text"
                    id="text"
                    name="text"
                ...
                {/* 優先度 */}
                <div className="mb-4">
                    <label htmlFor="priority" className="block text-gray-700 text-sm font-bold mb-2">優先度</label>
                    <select
                    id="priority"
                    name="priority"
                    value={task.priority}
                ...
                {/* タグ 言語のため、後々要設定*/}
                <div className="mb-4">
                    <label htmlFor="tag" className="block text-gray-700 text-sm font-bold mb-2">タグ</label>
                    <input
                    type="text" 
                    id="tag"
                    name="tag"
                ...
                {/* 担当者 */}
                <div className="mb-4">
                    <label htmlFor="assign" className="block text-gray-700 text-sm font-bold mb-2">担当者</label>
                    <input
                    type="text"
                    id="assign"
                    name="assign"
                ...
                {/* 締め切り */}
                <div className="mb-4">
                    <label htmlFor="deadline" className="block text-gray-700 text-sm font-bold mb-2">締め切り</label>
                    <input
                    type="date"
                    id="deadline"
                    name="deadline"
                ...
                {/* 1行メモ */}
                <div className="mb-4">
                    <label htmlFor="oneLine" className="block text-gray-700 text-sm font-bold mb-2">1行メモ</label>
                    <input
                    type="text"
                    id="oneLine"
                    name="oneLine"
                 ...
                 {/* 備考欄 */}
                <div className="mb-4">
                    <label htmlFor="memo" className="block text-gray-700 text-sm font-bold mb-2">備考欄</label>
                    <textarea
                    id="memo"
                    name="memo"
                    value={task.memo}
